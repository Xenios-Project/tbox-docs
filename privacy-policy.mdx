...
<p>
  At Xeniosmarkets, one of our main priorities is the privacy of our visitors. This Privacy Policy
  document contains types of information that is collected and recorded by Xeniosmarkets and how we
  use it.
</p>

<p>
  If you have additional questions or require more information about our Privacy Policy, please do
  not hesitate to contact us through email at [privacy@Xeniosmarkets.com](mailto:privacy@Xeniosmarkets.com).
</p>

<p>
  Xeniosmarkets follows a standard procedure of using log files. These files log visitors when they
...
<p>
  Like most other websites, Xeniosmarkets uses 'cookies'. These cookies are used to store
...
<p>
  Xeniosmarkets does not knowingly collect any Personal Identifiable Information from children under
...
<p>
  ...
  with regards to the information that they shared and/or collect in Xeniosmarkets. This policy is
  not applicable to any information collected offline or via channels other than this website.
</p>

<p>
  By using our website, you hereby consent to our Privacy Policy and agree to our Terms and
  Conditions.
</p>

<p>
  We are very delighted that you have shown interest in our enterprise. Data protection is of a
  particularly high priority for the management of Xeniosmarkets. The use of the Internet pages of
  Xeniosmarkets is possible without any indication of personal data; however, if a data subject
...
<p>
  ...
  accordance with the country-specific data protection regulations applicable to Xeniosmarkets. By
...
<p>
  As the controller, Xeniosmarkets has implemented numerous technical and organizational measures to
...
<ol>
  <li>
    ...
    <p>
      The data protection declaration of Xeniosmarkets is based on the terms used by the European
    ...
    <ol>
      ...
      <li>
        <p>Controller or controller responsible for the processing</p>
  ...
  <li>
    ...
    <p>[privacy@Xeniosmarkets.com](mailto:privacy@Xeniosmarkets.com)</p>
    <p>Website: Xeniosmarkets.com</p>
  </li>
  ...
  <li>
    ...
    <p>
      The Internet pages of Xeniosmarkets use cookies. Cookies are text files that are stored in a
    ...
    <p>
      Through the use of cookies, Xeniosmarkets can provide the users of this website with more
    ...
    <p>
      ...
      cart via a cookie. The data subject may, at any time, prevent the setting of cookies through
      our website by means of a corresponding setting of the Internet browser used, and may thus
      permanently deny the setting of cookies. Furthermore, already set cookies may be deleted at
  ...
  <li>
    ...
    <p>
      The website Xeniosmarkets.com collects a series of general data and information when a data
    ...
    <p>
      When using these general data and information, Xeniosmarkets does not draw any conclusions
      ...
      prosecution in case of a cyber-attack. Therefore, Xeniosmarkets analyzes anonymously collected
      data and information statistically, with the aim of increasing the data protection and data
      security of our enterprise, and to ensure an optimal level of protection for the personal data
  ...
  <li>
    ...
    <p>
      ...
      subject to. If the storage purpose is not applicable, or if a storage period prescribed by the
  ...
  <li>
    ...
    <ol>
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            ...
            erasure of personal data stored by Xeniosmarkets, he or she may, at any time, contact
            any employee of the controller. An employee of Xeniosmarkets shall promptly ensure that
        ...
        <p>
          ...
          personal data, as far as processing is not required. An employees of Xeniosmarkets will
      ...
      <li>
        ...
        <ul>
          ...
          <li>
            ...
            they are required by the data subject for the establishment, exercise or defense of
            legal claims.
          </li>
          ...
          <li>
            ...
            restriction of the processing of personal data stored by Xeniosmarkets, he or she may at
            any time contact any employee of the controller. The employee of Xeniosmarkets will
      ...
      <li>
        ...
        <p>
          Xeniosmarkets shall no longer process the personal data in the event of the objection,
        ...
        <p>
          If Xeniosmarkets processes personal data for direct marketing purposes, the data subject
          ...
          such direct marketing. If the data subject objects to Xeniosmarkets to the processing for
          direct marketing purposes, Xeniosmarkets will no longer process the personal data for
          these purposes.
        </p>

        <p>
          In addition, the data subject has the right, on grounds relating to his or her particular
          situation, to object to processing of personal data concerning him or her by Xeniosmarkets
        ...
        <p>
          ...
          Xeniosmarkets. In addition, the data subject is free in the context of the use of
      ...
      <li>
        ...
        <p>
          ...
          of, a contract between the data subject and a data controller, or (2) is not authorized by
        ...
        <p>
          ...
          explicit consent, Xeniosmarkets shall implement suitable measures to safeguard the data
        ...
        <p>
          ...
          decision-making, he or she may, at any time, contact any employee of Xeniosmarkets.
        </p>
      </li>
      ...
      <li>
        ...
        <p>
          ...
          at any time, contact any employee of Xeniosmarkets.
        </p>
      </li>
    </ol>
  </li>
  ...
  <li>
    <h3>Data protection provisions about the application and use of Twitter</h3>
    ...
    <p>
      ...
      about the Twitter buttons is available under [https://about.twitter.com/de/resources/buttons](https://about.twitter.com/de/resources/buttons).
      ...
      introduce this web page to the digital world and increase our visitor numbers. If the data
      subject is logged in at the same time on Twitter, Twitter detects with every call-up to our
      website by the data subject and for the entire duration of their stay on our Internet site
      ...
      of the data subject. If the data subject clicks on one of the Twitter buttons integrated on
      our website, then Twitter assigns this information to the personal Twitter user account of the
    ...
    <p>
      ...
      our website is made. The applicable data protection provisions of Twitter may be accessed
      under [https://twitter.com/privacy?lang=en](https://twitter.com/privacy?lang=en).
    </p>
  </li>
